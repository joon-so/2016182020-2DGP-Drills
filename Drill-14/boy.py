...
class Boy:
    ...
    def get_bb(self):
        return self.x - self.bg.window_left - 25, self.y - self.bg.window_bottom - 37, self.x - self.bg.window_left + 25, self.y - self.bg.window_bottom + 41
    ...
    def draw(self):
        ...
        self.font.draw(self.x - self.bg.window_left - 60, self.y - self.bg.window_bottom + 70, '(Ball: %d)' % (Boy.ball_count), (255, 0, 0))
        self.font.draw(self.x - self.bg.window_left - 60, self.y - self.bg.window_bottom + 55, '(%d, %d)' % (self.x, self.y), (255, 255, 0))
